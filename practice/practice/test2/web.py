...
def index():
    global numbersValue
    dingdongdang = []
    return render_template('/index.html',numbersValue=numbersValue,dingdongdang=dingdongdang)
...
def lotto():
    ...
    return render_template('/index.html',num1=num1,num2=num2,num3=num3,num4=num4,num5=num5,num6=num6,numbersValue=numbersValue,dingdongdang=dingdongdang,result=result)
